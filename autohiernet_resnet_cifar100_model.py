# Status: Complete
# Description: Model of Autohiernet:Resnet:Cifar100
...
class AutoHiernet(keras.Model):
    class ResidualBlock(tf.Module):
        ...
        def __call__(self, x):
            ...
            out = keras.layers.BatchNormalization(name=self.name_initial + "_bn1")(out)
    ...
    def get_late_node_block(self, A_out, n, resnet_n, name_initial: str, resnet_config, layer_split):
        ...
        X_pred = keras.layers.GlobalAveragePooling2D()(X_out)
