# Status: Complete
# Description: Simple resnet for cifar100, same as for cifar10
# Accuracy:
#   -resnet_n= 3: T1:86.53/67.07/65.96, T5:98.47/89.98/87.74
#   -resnet_n= 5: T1:94.23/67.75/67.08, T5:99.76/90.95/89.56
#   -resnet_n= 7: T1:97.04/68.69/68.12, T5:99.95/90.71/90.40
#   -resnet_n= 9: T1:98.37/68.67/68.38, T5:99.98/90.36/90.22
#   -resnet_n=18: T1:99.68/71.58/71.33, T5:100.0/91.27/91.28
# Parent: resnet_cifar10.py
# Story:
#   -Tried the same resnet as for cifar10, just with more outputs, reached 98.23/68.11
#   -Tried quadrupeling(4x) the number of filters in every residual block, achieved higher training and a little higher test accuracy (99.96/68.75), but not using that because it took much more time to train
#   -Corrected inherited resnet bug
#   -Tried using CosineDecay, achived similar accuracy
#   -Run for n=3,5,7,9,18
#   -For n=18: with custom schedule 99.63/71.09, without custom schedule 99.36/65.66
#   -Added test set by dividing validation to 5000/5000, changed model save format to h5
#   -Changed once again test/val split to be more consitstent
import argparse
